...
- ❌ SSH port 2222 accessible from host
...
### Container Status
**Processes Running**:
- root           1  0.1  0.3  35684 27848 pts/0    Ss+  02:59   0:00 /usr/bin/python3 /usr/bin/supervisord -c /etc/supervisor/supervisord.conf
...
- develop+      28  0.2  0.0  15048  7212 ?        S    02:59   0:00 sshd: developer@pts/1
